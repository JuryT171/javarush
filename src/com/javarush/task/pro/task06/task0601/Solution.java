...
public class Solution {
    public static void main(String[] args) {
        printHydrogenInfo();   //  вызвали оба метода внутри главного
        printJavaInfo();
    }
    public static void printHydrogenInfo(){   //  создали метод printHydrogenInfo
    ...
    public static void printJavaInfo(){  // создали метод  printJavaInfo
