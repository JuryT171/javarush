...
public class Solution {
    ...
    public static Stream<Language> sortByRanking(ArrayList<Language> languages) {
        ...
        return languages.stream().sorted(((o1, o2) // запускаем поток, сортируем, присваиваем имена 2м объектам языков для сравнения
                -> Double.compare(o2.getRanking(), o1.getRanking())));  // Сравниваем объекты(их рейтинг) типа дабл (компаратор лямбда)
    }
}
