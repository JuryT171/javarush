...
public class Solution {
    ...
    public static boolean hasExpiredProduct(Stream<Product> productStream) {
       ...
       LocalDate today = LocalDate.now(); // текущая дата
        ...
        //  вызываем метод эниматч, получаем дату, и сравниваем методом исбефоре с текущей
       // return productStream.anyMatch(p -> p.getExpirationDate().isBefore(LocalDate.now()));
    }
}
