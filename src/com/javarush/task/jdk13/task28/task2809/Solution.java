...
public class Solution {
    public static ExecutorService executorService = Executors.newSingleThreadExecutor(); // создаем сервис с 1 потоком
    ...
    public static Future<String> startPlaying(String name) {
        ...
        return executorService.submit(new MusicalInstrument(name)); //  возвращаем решение задачи
    }
